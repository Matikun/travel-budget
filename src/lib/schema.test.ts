...
describe('defaultBudgetValues', () => {
  ...
  it('default factories match schema shape', () => {
    ...
    expect(defaultFlight().photoDataUrl).toBeUndefined()
    expect(defaultFlight().showPhotoInPdf).toBe(true)
    ...
    expect(defaultHotel().photoDataUrl).toBeUndefined()
    expect(defaultHotel().showPhotoInPdf).toBe(true)
    expect(defaultExcursion().name).toBe('')
    expect(defaultExcursion().showPriceInPdf).toBe(true)
    expect(defaultExcursion().photoDataUrl).toBeUndefined()
